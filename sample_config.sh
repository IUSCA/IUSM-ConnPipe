...
if $fMRI_A; then
	...
	export configs_EPI_epiMax=3 # maximum scan index
	...
	export flags_EPI_ReadHeaders=true 
		...
		export flags_EPI_UseJson=true 

	#==============================================================================#
	#=================================   UNWARPING  ===============================#
	#==============================================================================#
    # User should select the appropriate BOLD image distortion protocol: 
	# 1) Spin echo field maps
	# 2) Gradient echo field maps
	...
	export configs_EPI_skipFMcalc4EPI=1 # Skip SEmap/GREFM calculation for EPInum > configs_EPI_skipFMcalc4EPI
